            ...
            <ul class="section menu" style="margin-right:10px;">
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="catlist.php">Danh mục sp</a> </li>
                    </ul>
                </li>
                <li>
                    <a class="menuitem">THƯƠNG HIỆU SP</a>
                    <ul class="submenu">
                        <li><a href="brandadd.php">Thêm thương hiệu</a> </li>
                        <li><a href="brandlist.php">Thương hiệu sp</a> </li>
                    </ul>
                </li>
                <li><a class="menuitem">SẢN PHẨM</a>
                    <ul class="submenu">
                        <li><a href="productadd.php">Thêm sản phẩm</a> </li>
                        <li><a href="productlist.php">Liệt kê sp</a> </li>
                    </ul>
                </li>
